...
public @interface NoWhitespaceConstraint {
    ...
    class NoWhitespaceValidator implements ConstraintValidator<NoWhitespaceConstraint, String> {
        ...
        public static void validate(String value) {
            if (StringUtils.containsWhitespace(value)) {
                throw new IllegalArgumentException("The string must not contain whitespace");
            }
        }
    }
