...
public struct QueryUserGroupInvitationsRequest {
...
extension QueryUserGroupInvitationsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryUserGroupInvitationsRequest"
  ...
  public static func ==(lhs: QueryUserGroupInvitationsRequest, rhs: QueryUserGroupInvitationsRequest) -> Bool {
