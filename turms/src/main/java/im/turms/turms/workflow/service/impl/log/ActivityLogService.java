        ...
        switch (name) {
            ...
            case QUERY:
                return Set.of(
                        ...
                        QUERY_USERS_IDS_NEARBY_REQUEST,
                        QUERY_USERS_INFOS_NEARBY_REQUEST,
                        QUERY_USERS_ONLINE_STATUS_REQUEST,
                        QUERY_FRIEND_REQUESTS_REQUEST,
                        QUERY_RELATED_USERS_IDS_REQUEST,
                        QUERY_RELATIONSHIP_GROUPS_REQUEST,
                        QUERY_RELATIONSHIPS_REQUEST,
                        QUERY_GROUP_REQUEST,
                        QUERY_JOINED_GROUPS_IDS_REQUEST,
                        QUERY_JOINED_GROUPS_INFOS_REQUEST,
                        QUERY_GROUP_BLACKLISTED_USERS_IDS_REQUEST,
                        QUERY_GROUP_BLACKLISTED_USERS_INFOS_REQUEST,
