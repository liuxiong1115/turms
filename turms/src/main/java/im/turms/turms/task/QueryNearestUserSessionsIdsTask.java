...
@SpringAware
public class QueryNearestUserSessionsIdsTask implements Callable<Iterable<Entry<Pair<Long, DeviceType>, PointFloat>>>, Serializable, ApplicationContextAware {
    ...
    public QueryNearestUserSessionsIdsTask(
    ...
    @Override
    public Iterable<Entry<Pair<Long, DeviceType>, PointFloat>> call() {
        return usersNearbyService.getNearestUserSessionIds(PointFloat.create(longitude, latitude), maxDistance, maxNumber);
    }
